    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      ...
      builder.Entity<Review>()
          .HasData(
              ...
              new Review { ReviewId =2, UserName = "user2", Description = "I loved this place. If your are an art lover, this place is a paradise for you. One day is not enough to visit the entire museum. But still you can visit the main attractions including the famous Mona Lisa." , Rating = 4, DestinationId = 1 },
              new Review { ReviewId =3, UserName = "user2", Description = "Wow! Sydney Opera House is absolutely FABULOUS! What an elegant, gorgeous, impressive display of truly artistic architecture.  The beauty of this site is enhanced with each different view. " , Rating = 4, DestinationId = 2 },
              new Review { ReviewId =4, UserName = "user1", Description = "This was a great way to get to know the city of Portland! It was fascinating to learn about one of the first wealthy families to live there. The mansion is really cool and the hike through forest park is a fun way to get there! " , Rating = 3, DestinationId = 3 },
              new Review { ReviewId =5, UserName = "user3", Description = "It is one of the best places on South Korea to see the old architecture of a palace. Even traditional events are demonstrate times to time. The most interesting thing in this place is that you can take photographs with soldiers with traditional costumes." , Rating = 5, DestinationId = 5 }
          );    
    }
  }
}  